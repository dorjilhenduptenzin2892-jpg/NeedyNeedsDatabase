                  ...
                  <div className="flex items-center gap-6 w-full sm:w-auto justify-between sm:justify-end">
                     ...
                     <div className="flex gap-2 items-center">
                        <button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              const ids = group.map(o => String(o.id).trim());
                              if (window.confirm(`WARNING: This will permanently delete ALL ${ids.length} order records for this customer. Do you want to proceed?`)) {
                                onDelete(ids);
                              }
                            }}
                                        ...
                                        <div className="flex items-center justify-end gap-2">
                                            ...
                                            <button 
                                              ...
                                              onClick={(e) => {
                                                ...
                                                if (window.confirm("Are you sure you want to permanently delete this specific order record?")) {
                                                  onDelete(id);
                                                }
                                              }} 
                  ...
                  <div className="bg-slate-50 p-6 border-t border-slate-200 shrink-0">
                      ...
                      <div className="grid grid-cols-2 gap-3 mt-2">
                            ...
                            <button 
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                const ids = selectedGroupOrders.map(o => String(o.id).trim());
                                if (window.confirm(`WARNING: This will permanently delete ALL ${ids.length} order records for this customer. Do you want to proceed?`)) {
                                  onDelete(ids);
                                  setSelectedCustomerKey(null);
                                }
                              }} 
                              className="py-3 bg-white border border-rose-200 text-rose-600 font-medium rounded-xl hover:bg-rose-50 transition-colors flex items-center justify-center gap-2"
                            >
